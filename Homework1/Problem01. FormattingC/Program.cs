namespace Problem01.FormattingC
{
    ...
    public class Program
    {
        ...
        public class EventHolder
        {
            ...
            public MultiDictionary<string, Event> OrderByTitle
            {
                get { return this.orderByTitle; }
                set { this.orderByTitle = value; }
            }

            public OrderedBag<Event> OrderByDate
            {
                get { return this.orderByDate; }
                set { this.orderByDate = value; }
            }
